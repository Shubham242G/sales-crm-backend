export const ERROR = {
  ...
  SERVICE: {
    EXIST: "SERVICE in this name is already exists.",
    SLUG: "SERVICE in this slug is already exists.",
    DISCRIPTIONEXIST: "SERVICE in this discription is already exists.",
    NOT_FOUND: "Can't find the SERVICE.",
    INVALID_ID: "SERVICE id is not valid",
    CANT_DELETE: "Product found under this SERVICE.",
  },
  CATEGORY: {
