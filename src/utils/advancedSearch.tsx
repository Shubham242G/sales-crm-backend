...
const AdvancedSearch: React.FC<AdvancedSearchProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 w-[400px] max-h-[60vh] overflow-y-auto">
        ...
        {fields.map((field) => (
          <div key={field.key} className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <select
                className="border border-gray-300 rounded-md text-sm px-2 py-1 h-[36px] text-gray-700"
                value={conditions[field.key] || "contains"}
                onChange={(e) =>
                  handleConditionChange(field.key, e.target.value)
                }
              >
            ...
            {field.type === "select" && field.options ? (
              <select
                className="border border-gray-300 rounded-md px-3 py-2 h-[38px] text-[14px] text-gray-700 w-full"
