  ...
  return (
    <>
      ...
      {/* <div className="container ">
        ...
        className={"leadtable"}
        //new fields
        TableName={" All Banquet List"}
        TableGetAllFunction={useBanquet}
        ExcelExportFunction={getBanquetExcel}
        TableAddExcelFunction={addBanquetExcel}
        RouteName={"Add Banquet"}
        AddButtonRouteName={"/banquet"}
        AddButtonName={"New Banquet"}
        placeholderSearch={"Search by banquet name"}
      /> 
    </>
  );
}
