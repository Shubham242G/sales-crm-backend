...
import { useDepartmentMaster, usedeleteDepartmentMasterById, IDepartmentMaster} from "@/services/departmentMaster.service";
import { pageIndex, pageSize } from "@/common/constant.common";
function DepartmentMasterListView() {
    const navigate = useNavigate();
    const { data: DepartmentData } = useDepartmentMaster({pageIndex:0,pageSize:1000});
