...
const AddEnquiryForm = () => {
    ...
    const handleMealPlanChange = (
        table: Room[] | Cab[],
        setTable: React.Dispatch<React.SetStateAction<Room[] | Cab[]>>,
        index: number,
        value: string
    ): void => {
    ...
    const addEventDate = () => {
        setEventSetup({...eventSetup, eventDates:[{ startDate: '', endDate: '' }]});
    };

    const handleDateChange = (index:number, field:any, value:any) => {
        const updatedDates:any = [...eventSetup.eventDates];
        updatedDates[index][field] = value;
        setEventSetup(updatedDates);
    };
    ...
    return (
        <div className="p-12 bg-gray-50 rounded-md shadow-md">
            <h2 className="font-bold text-lg mb-4">Enquiry</h2>
